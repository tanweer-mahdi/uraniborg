...
Define the repository, branch, CI, and npm publishing governance required to release Uraniborg from reviewed source code with a deterministic package boundary.
